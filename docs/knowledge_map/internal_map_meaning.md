...
| U-M12 | در میان این سه، «تناقض و عدم تناقض» پایه‌تر از «وجود و عدم» و «کل و جزء» است. | تصمیم مستقیم کاربر، ۲۰۲۶-۰۸-۱۱ |
...
این نمودار اکنون وجودِ بخشی از معناهای اولیه، سه مصداق انتخاب‌شده و پایه‌تر بودن «تناقض و عدم تناقض» را موضع تأییدشدهٔ کاربر می‌داند. پیکان‌های نقطه‌چین فقط تقدم انتخاب‌شده را نشان می‌دهند؛ هنوز مشخص نیست دو مورد دیگر چگونه به آن وابسته‌اند و تجربه این معناها را فعال، ترکیب، تفکیک یا گسترش می‌دهد.
...
> «تناقض و عدم تناقض» در میان این سه پایه‌تر است.

پرسش بعدی این است:

> تناقض و عدم تناقض در هسته «یک معنای اولیه»، «اصل داوری دربارهٔ معناها» یا هر دو است؟

تا معنای دقیق «پایه‌تر» با زبان خودت مشخص نشود، نباید از طرف پروژه وابستگی یا معماری هسته را تثبیت کنیم.
