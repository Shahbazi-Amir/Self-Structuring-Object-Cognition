...
این نمودار اکنون وجودِ بخشی از معناهای اولیه را موضع تأییدشدهٔ کاربر می‌داند. اما هنوز مشخص نمی‌کند آن معناها دقیقاً کدام‌اند و تجربه آن‌ها را فعال، ترکیب، تفکیک یا گسترش می‌دهد؛ این افعال فعلاً فرضیه‌های کاری‌اند.
...
**پرسش باز:** نخستین فهرست حداقلیِ معناهای اولیه چیست و تجربه دقیقاً چه تغییری در آن‌ها ایجاد می‌کند؟
...
- اینکه هنوز می‌دانیم دقیقاً کدام معناها اولیه‌اند.
- اینکه نظریهٔ چامسکی، فطرت دینی و بدیهیات فلسفی دقیقاً یک مفهوم را بیان می‌کنند.

## تصمیم لازم برای ادامه

دوشاخهٔ نخست تعیین شد:

> بخشی از معناها از ابتدا در هسته وجود دارند.

تصمیم بعدی این است:

> حداقل یک نمونهٔ قطعی از «معنای اولیه» چیست؟

تا نمونهٔ نخست با زبان خودت مشخص نشود، نباید از طرف پروژه فهرستی از معناهای فطری بسازیم یا معماری آن را تثبیت کنیم.
